    ...
    >
      <DialogContent>
        <div className='h-full min-h-screen px-4 text-center'>
          ...
          <div
            className='inline-block max-h-[90%] w-full max-w-xl transform overflow-auto rounded-xl bg-white p-6 text-left align-middle shadow-xl transition-all dark:bg-dark-800'>
